    ...
    <Flex justify="space-between" alignItems="flex-start" width="100%">
      <Box flex="1" m={4}>
        ...
        <br />
          ...
          <Text fontSize='xs' as='cite'>Enter your Wallet address at ETH</Text>
        <Input
          type="text"
          value={destWallet}
        ...
        <Text fontSize='xs' as='cite'>** The fees include gas cost for all 3 necessary transactions.</Text>
          ...
          <Text fontSize='xs' as='cite'><FontAwesomeIcon icon={faGasPump} beat size="xs" /> Gas Fees: <strong>{roundedFeeValue} BNB</strong></Text>  
