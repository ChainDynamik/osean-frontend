...
export default function Swapbnb() {
  ...
  const handleProposal = async () => {
    try {
      ...
      const swapData = voteContract?.encoder.encode("swapBNB", [amountInWei]);
        ...
        <Flex justify="space-between" alignItems="flex-start" width="100%">
          <Box flex="1" m={4}>
            <FormControl>
              ...
              <h6>This is a prebuilt proposal for making a Swap BNB to OSEAN proposal from our Dao Treasury</h6>
