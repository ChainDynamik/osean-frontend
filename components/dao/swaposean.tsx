...
export default function SwapOsean() {
  ...
  const handleProposal = async () => {
    try {
      ...
      const swapData = voteContract?.encoder.encode("swapOSEAN", [amountInWei]);
        ...
        <Flex justify="space-between" alignItems="flex-start" width="100%">
          <Box flex="1" m={4}>
            <FormControl>
              ...
              <h6>This is a prebuilt proposal for making a Swap Osean to BNB proposal from Dao Treasury</h6>
