...
export default function TransferBNB() {
  ...
  const transfer = async () => {
    try {
        ...
        const targets = [wallet]; // The recipient wallet
        const values = [weiAmount]; // Amount to send in WEI
  ...
  return (
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
      ...
      <FormControl>
        <h3>Transfer BNB</h3>
        <Text>This is a prebuilt proposal to send a BNB amount from treasury to the CEO Wallet.</Text>
