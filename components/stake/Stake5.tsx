import {
  ...
  import {
    REWARD_TOKEN_ADDRESSES_D,
    STAKE2_CONTRACT_ADDRESSES_D,
    STAKE_TOKEN_ADDRESSES_D,
    NETWORK
...
import { ClassNames } from "@emotion/react";
  ...
  export default function Stake5() {
    ...
    return (
      <Card /*style={{backgroundColor: "#f9f8ff"}}*/ p={5} mt={10} className="card__earn" >
        ...
        <br />Only Skipper NFT holders can stake in this tab - Base APR 18%.
        <SimpleGrid columns={2} className="card-block-wrapper">
          <Card p={5} m={5} className="card__stake">
            ...
            <SimpleGrid columns={2} spacing={4} className="stake-and-reward-wrapper">
              <Stack spacing={4}>
                ...
                />
                <Web3Button className="btn btn-lg btn-round mt-0 btn-gradient-orange animated" data-animation="fadeInUpShorter" data-animation-delay="1.7s"
                  contractAddress={STAKE2_CONTRACT_ADDRESSES_D}
          ...
          <Card p={5} m={5} className="card__reward">
            ...
            >
              ...
              <Web3Button style={{width: "fit-content", textAlign: "center"}} className="btn btn-lg btn-round mt-0 btn-gradient-orange animated" data-animation="fadeInUpShorter" data-animation-delay="1.7s"
                contractAddress={STAKE2_CONTRACT_ADDRESSES_D}
                action={async (contract) => {
        ...
        <p style={{ textAlign: 'center' }}> <br />
          ...
          <a
            ...
            href="https://bscscan.com/address/0x3b8391EEb8a07C7D31E1719158177B36dc786022"
          >
            bscscan{' '}
            <span
