...
import CalldataDecoder from "./calldata-decoder/index";
import Link from "next/link";
import { DAO_ADDRESS } from "../cost/addresses";

const Decoder: NextPage = () => {
  ...
  return (
                    ...
                    <div className="head-content container-fluid">
                        <div className="container">
                            ...
                            <div className="breadcrumb">
                                ...
                                <a className="current">Decode a Proposal</a>
                            </div>
    ...
    <Container maxW={"1200px"}>
      ...
      <p style={{ textAlign: 'center' }}> <br />
        ...
        <p style={{ textAlign: 'center', marginBottom: "0px" }}>
          Get OSEAN token contract ABI {' '}
          <a
            target="_blank"
            rel="noopener"
            className="chakra-link chakra-button css-1c0d5xu"
            href={`https://osean.online/assets/oseanABI.json`}
          >
            here{' '}
            <span
              style={{ display: 'inline-block' }}
        ...
        <p style={{ textAlign: 'center' }}>
          Get Governance NFT contract ABI {' '}
          <a
            target="_blank"
            rel="noopener"
            className="chakra-link chakra-button css-1c0d5xu"
            href={`https://osean.online/assets/nftgovABI.json`}
          >
            here{' '}
            <span
              style={{ display: 'inline-block' }}
