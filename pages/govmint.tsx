...
const Home: NextPage = () => {
  ...
  return (
    ...
    <div className="mt-5">
    <Link href="/skippersmint" rel="noopener noreferrer">
    <Image src="https://osean.online/assets/GOVbanner.jpg" 
      alt="Gov Banner"
      width={1280}
      height={189}
      layout="responsive"
    ...
    <div className={styles.heroSection}>
        ...
        <p style={{ textAlign: 'center' }}> <br />
          ...
          <a
            ...
            href={`https://bscscan.com/address/${GOV_NFT}`}
          >
            bscscan{' '}
            <span
